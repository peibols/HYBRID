...
{
	char glauFile[100];
	sprintf(glauFile,"/gs/project/cqn-654-ad/cshen/MUSIC_pA_3+1d/pPb/initial_conditions_MCGlbpPb5020C%s_Chanwook/rho_binary_event_%i_block.dat",cent.c_str(),nhyd);	
